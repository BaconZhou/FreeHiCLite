...
#' @param chromosomes A vector contains all the chromosomes. For example c("chr1", "chr2"), the resulting contact matrixs will include all the pairs of interaction (chr1_chr1, chr1_chr2, chr2_chr2). 
#' @param pair A vector contains all the pair. The pair take format as "1_1" or "chr1_chr1", both means the contact between chromosome1 and chromosome1. If \code{pair} presents, \code{chromosomes} argument will be ignore.
#' @param unit Unit only supports c("BP", "FRAG"). "BP" means base-pair, and "FRAG" means fragment.
#' @param resolution The desired resolution of the contact matrix. The resolution must be a value from following list.
#' \itemize{
#' \item{\strong{unit: BP}}
#' \itemize{
#' \item 2500000
...
#' \item{chromosomeSizes} The list of chromsomeSize. Can be used in juicer pre function.
#' }}
