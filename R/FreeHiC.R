...
#' 
#' res <- FreeHiCJuicer(file=localFilePath, chromosomes=chromosomes, 
...
FreeHiCJuicer <- function(file, chromosomes = NULL, pairs = NULL, unit = c("BP", "FRAG"), seqDepth = NULL, 
    ...
    ans <- hicDataSimuFromFile(file, isHttp, pairClean, unit, resolution, seqDepth, countScale, noiseRate, 
        neighborZeroRate)
