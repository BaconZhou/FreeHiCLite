#ifndef HICLIB_KDTREE_HPP
#define HICLIB_KDTREE_HPP

// file obtained from
// https://github.com/jmhodges/kdtree2/blob/master/src-c%2B%2B/kdtree2.hpp
...
typedef std::vector<contactRecord> KDTreeArray;
...
class KDTree {
  ...
  public:
    ...
    void n_nearest_brute_force(contactRecord &qv, int nn,
    ...
    void n_nearest(contactRecord &qv, int nn, KDTreeResultVector &result);
    ...
    void r_nearest(contactRecord &qv, float r2,
                   KDTreeResultVector &result);
    ...
    int r_count(contactRecord &qv, float r2);
